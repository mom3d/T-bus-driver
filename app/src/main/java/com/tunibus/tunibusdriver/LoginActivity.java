...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     */
    private FirebaseAuth mAuthTask=FirebaseAuth.getInstance();
    ...
    private void attemptLogin() {
        ...
        //chek if the password field is not empty
        ...
        if (cancel) {
            ...
            showProgress(true);
            //TODO:hna na3mlou login firebase
            mAuthTask.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(LoginActivity.this,"erreur lors connection",Toast.LENGTH_LONG).show();
